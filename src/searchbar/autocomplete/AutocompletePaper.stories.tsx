...
export const closed = () => <Wrapper>
    <AutocompletePaperWithOutline target={<TextField />} open={false}>
        <Typography variant="body2">Some contents...</Typography>
    </AutocompletePaperWithOutline>
</Wrapper>;

export const open = () => <Wrapper>
    <AutocompletePaperWithOutline target={<TextField />} open={true}>
        <Typography variant="body2">Some contents...</Typography>
    </AutocompletePaperWithOutline>
</Wrapper>;
...
export const interactive = () => {
    ...
    return <Wrapper>
        <AutocompletePaperWithOutline target={<TextField value={value} onChange={(e) => setValue(e.target.value)} />} open={value.length > 0}>
